-- 015_fix_duel_days_left.sql
-- days_left contava o dia corrente mesmo já decorrido.
...
begin
  ...
  v_days_left := greatest(0, least(6, v_week_end - greatest(current_date, v_week_start)));
