-- Allows the registration status to remain until administrative enrollment closes.
-- Activity is still restricted by the season date window and active participation.
